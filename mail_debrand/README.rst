...
=============
* Odoo 19.0+
* Migration: Benedito Monteiro (2024)

Migration Notes
===============
This module has been migrated to Odoo 19.0 with the following enhancements:
- Support for QWeb template engine replacing Jinja
- Updated API decorators (@api.model_create_multi)
- Enhanced template rendering with engine parameter support
